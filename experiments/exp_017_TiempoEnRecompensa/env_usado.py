...
Recompensa:
        - Penalización temporal por paso no terminal: -0.02
    - Al final por truncación: suma de dos términos:
      1) Balance habitaciones en [0, 10]: 10 * ((2/3 - desbalanceo) / (2/3))
            2) Penalización cuadrática C: -50 * p_C^2 donde p_C = visitas_C / suma(visitas_totales)
